...
const views = {
  fifths: { file: "fifths.png", width: 1480, height: 900, alt: "Inputs around the circle with editable comma formulas, a cent-deviation bar chart and catalogue suggestions.", caption: "Load a catalogue temperament or set each fifth in comma fractions, then export a chart relative to A." },
  commas: { file: "commas.png", width: 1480, height: 900, alt: "Formula list with combined comma expressions, a coloured fifth circle and a cent-deviation bar chart.", caption: "Combine Pythagorean, syntonic and schisma expressions in wide formula fields." },
  harmony: { file: "harmony.png", width: 1480, height: 900, alt: "Harmony lattice with a selected C-major chord, Principal 8' playback checkbox and adjustable reverb and loudness.", caption: "Inspect a chord's intervals and hear it on the sampled Principal 8', with adjustable reverb and loudness." }
};
...
for (const el of document.querySelectorAll("[data-version]")) el.textContent = config.version || "1.7.0";
